<?php include '../includes/status-update-for-private-map-layout.php';?>
<!DOCTYPE html>
<html lang="en">
<head>s
  <meta charset="UTF-8">
  ...
  <body>
  <?php include '../includes/navagation-for-private-map-layout.php';?>
  <div class="top-view">
            ...
            <div class="main-col1">
              <div class="main-classrooms1">
                <div class="main-classroom">
                  <button <?php echo getColor(1);?>>Room 1
                </button>
                </div>
                <div class="main-classroom">
